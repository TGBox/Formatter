...
/**
 * Created by Daniel Roesch as "Nils Darmstrong". ----------------- For "TextFormatter", on
 * 08.04.2017, 16:06.
 */
public class TextFormatterGUI extends JFrame {
  ...
  /**
   * Method to replace all appearances of a specified substring with another String within a given
   * String.
   *
   * @param unwanted the unwanted String that has to be replaced.
   * @param replacement the replacement String which will be inserted for every appearance.
   * @param string the String that will be searched if it contains the unwanted String.
   * @param caseSensitive boolean flag to indicate if the replacement process will be applied only
   * if the case sensitivity of the results match. True for case sensitivity, false otherwise.
   * @return searched and (possibly) altered original String.
   */
